...
Route::post('/donation-pay', [DonationPayController::class, 'redirectToGateway'])->name('donation-pay');
Route::get('/payment/callback2', [DonationPayController::class, 'handleGatewayCallback']);
...
Route::delete('admin/donations/{donation}', [dminDonationController::class, 'destroy'])->name('delete-donations');
