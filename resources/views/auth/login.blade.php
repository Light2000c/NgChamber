           ...
           @endif
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <input id="form_username_email" name="email" class="form-control" type="email" placeholder="example@gmail.com">
                      @error('email')
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <input id="form_password" name="password" class="form-control" type="password" placeholder="Enter Your Password">
                      @error('password')
                      <small class="text-danger">{{ $message }}</small>
                      @enderror
                    </div>
