		...
		<div class="page-wrapper full-page">
           ...
           @endif
                      <div class="mb-3">
                        ...
                        <input type="email" value="{{ old('email') }}" name="email" class="form-control" id="userEmail" placeholder="example@gmail.com">
                        @error('email')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password"  name="password" class="form-control" id="userPassword" autocomplete="current-password" placeholder="Enter Your Password">
                        @error('password')
                      <small class="text-danger">{{ $message }}</small>
                      @enderror
                      </div>
