    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Ambassadors</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add Ambassadors</h4>

                        <form action="{{ route('add-ambassadors') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control "  name="name" value="{{ old('name') }}"
                                        id="defaultconfig" type="text" placeholder="Enter Ambassador Name" style="background-color: whitesmoke;">
                                    @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control "  name="position" value="{{ old('position') }}"
                                            id="defaultconfig" type="text" placeholder="Enter Ambassador Position" style="background-color: whitesmoke;">
                                        @error('position')
                                            <small class="text-danger">{{ $message }}</small>
                                            @endif
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-3">
                                            <label for="defaultconfig-3" class="col-form-label">Role</label>
                                    </div>
                                        <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea name="description" value="{{ old('description') }}" id="maxlength-textarea" class="form-control"
                                                    id="defaultconfig-4"  rows="5" style="background-color: whitesmoke;">About ambassador......</textarea>
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @endif
                                                    <div class="d-grid mt-3">
                                                        <button class="btn btn-primary btn-sm" type="submit">Add Ambassador</button>
