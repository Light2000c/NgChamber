        ...
        <div class="row">
          <div class="col-md-7">
            <div class="p-40 pl-0">
              ...
              <form id="reservation_form" name="reservation_form" class="reservation-form" method="post" action="includes/reservation.php"><h3 class="mt-0 line-bottom mb-40">Get A Free<span class="text-theme-color-2"> Service Now!</span></h3>
                <div class="row">
                  <div class="col-sm-12">
