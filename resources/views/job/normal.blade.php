    ...
    <section>
      ...
      <div class="col-md-3 p-15">
        ...
        <ul class="nav nav-pills nav-stacked">
          <li class="active "><a style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 20px;" href="{{ route('normal-jobs') }}">Jobs</a></li>
          <li ><a style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 20px;" href="{{ route('intern-jobs') }}">Internship</a></li>
        </ul>
      </div>
        ...
        <div class="row">
          <div class="col-md-10">
            <div>
             ...
             @endforeach
             @else
             <div class="alert alert-secondary" role="alert" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 20px;">
                Intership jobs not available at the moment!
              </div>
             @endif
